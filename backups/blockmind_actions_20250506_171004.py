...
def look_around(context, player_position, vision_range=5):
    """
    Scans the surroundings for meaningful objects or entities.
...
def gather_info(context=None):
    """
    Scan the screen for any meaningful information.
